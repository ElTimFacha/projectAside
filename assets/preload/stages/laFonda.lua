function onCreate()
	makeLuaSprite('bg', 'Bgs/weekMostaza/BG', 0, 0);
	setLuaSpriteScrollFactor('bg', 1.0, 1.0);
	
	makeLuaSprite('Eatingtable', 'Bgs/weekMostaza/Eatingtable', 0, 0);
	setLuaSpriteScrollFactor('Eatingtable', 1.0, 1.0);
	scaleObject('Eatingtable', 2.0, 2.0);

   makeLuaSprite('Tables', 'Bgs/weekMostaza/Tables', -150, 0);
	setLuaSpriteScrollFactor('Tables', 0.9, 0.9);
	scaleObject('Tables', 2.0, 2.0);
   
   makeLuaSprite('overlayMexicano', 'Bgs/weekMostaza/overlayMexicano', 0, 0);
	setLuaSpriteScrollFactor('overlayMexicano', 1.0, 1.0);
	scaleObject('overlayMexicano', 2.0, 2.0);
